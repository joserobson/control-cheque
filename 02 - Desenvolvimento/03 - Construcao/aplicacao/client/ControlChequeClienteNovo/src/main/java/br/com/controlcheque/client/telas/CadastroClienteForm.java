...
public class CadastroClienteForm extends CadastroBaseForm implements InterfaceCadastroCompleto {
    ...
    public CadastroClienteForm(String codigo) {
        initComponents();
        this.codigo = codigo;
    }
    ...
    public void pushToModel() {
        ...
        cliente.setRuaEndereco(txt_rua.getText());
        cliente.setBairroEndereco(txt_bairro.getText());
        cliente.setCidadeEndereco(txt_cidade.getText());
        cliente.setComplementoEndereco(txt_complemento.getText());
        cliente.setNumeroEndereco(txt_numero.getText());
    ...
    public Object salvar() throws ClientChequeException {
        try {
            pushToModel();
            return clienteServer.mantemObject(cliente);
